...
namespace ApiConection.Controllers
{
	...
	public class AccountController : ApiController
	{
		...
		public async Task<ManageInfoViewModel> GetManageInfo ( string returnUrl, bool generateState = false )
		{
			...
			foreach ( libProduccionDataBase.Identity.ApplicationUserLogin linkedAccount in user.Logins )
			{
		...
		public async Task<IHttpActionResult> GetExternalLogin ( string provider, string error = null )
		{
			...
			libProduccionDataBase.Identity.ApplicationUser user = await UserManager.FindAsync ( new UserLoginInfo ( externalLogin.LoginProvider,
			...
			if ( hasRegistered )
			{
				...
				AuthenticationProperties properties = ApplicationOAuthProvider.CreateProperties ( user.UserName, user.Nombre, user.ApellidoPaterno, user.ApellidoMaterno, user.ClaveTrabajador, roles.ToArray ( ), user.Id );
		...
		public async Task<IHttpActionResult> Register ( RegisterBindingModel model )
		{
			...
			var user = new libProduccionDataBase.Identity.ApplicationUser ( ) { UserName = model.Email, Email = model.Email, Nombre = model.Nombre, ApellidoPaterno = model.ApellidoPaterno, ApellidoMaterno = model.ApellidoMaterno, ClaveTrabajador = model.ClaveTrabajador, Estatus = libProduccionDataBase.Identity.ApplicationUser.status.Activo };
		...
		public async Task<IHttpActionResult> RegisterExternal ( RegisterExternalBindingModel model )
		{
			...
			var user = new libProduccionDataBase.Identity.ApplicationUser ( ) { UserName = model.Email, Email = model.Email };
