namespace ContabilidadIntelisisRep_AddIn.Forms {
	partial class frmIntegracionSaldos {
		/// <summary>
		...
		private void InitializeComponent ( ) {
			...
			// 
			this.integracionSaldosDataGridView.AllowUserToAddRows = false;
			this.integracionSaldosDataGridView.AllowUserToDeleteRows = false;
			dataGridViewCellStyle1.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(224)))), ((int)(((byte)(224)))), ((int)(((byte)(224)))));
			dataGridViewCellStyle1.SelectionBackColor = System.Drawing.Color.Silver;
			this.integracionSaldosDataGridView.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
			this.integracionSaldosDataGridView.AutoGenerateColumns = false;
			this.integracionSaldosDataGridView.ClipboardCopyMode = System.Windows.Forms.DataGridViewClipboardCopyMode.EnableAlwaysIncludeHeaderText;
			this.integracionSaldosDataGridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.integracionSaldosDataGridView.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
			...
			this.integracionSaldosDataGridView.Location = new System.Drawing.Point(0, 32);
			this.integracionSaldosDataGridView.Name = "integracionSaldosDataGridView";
			this.integracionSaldosDataGridView.ReadOnly = true;
			this.integracionSaldosDataGridView.RowHeadersWidth = 20;
			this.integracionSaldosDataGridView.RowHeadersWidthSizeMode = System.Windows.Forms.DataGridViewRowHeadersWidthSizeMode.DisableResizing;
			...
			this.label1.Text = "MovId:";
			// 
			// button2
			// 
			this.button2.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.button2.Image = global::ContabilidadIntelisisRep_AddIn.Properties.Resources.magnifier;
			this.button2.Location = new System.Drawing.Point(798, 5);
			...
			this.textBox1.Location = new System.Drawing.Point(692, 8);
			...
			// 
			this.dataGridViewTextBoxColumn9.DataPropertyName = "Mov";
			this.dataGridViewTextBoxColumn9.HeaderText = "Mov";
			this.dataGridViewTextBoxColumn9.Name = "dataGridViewTextBoxColumn9";
			this.dataGridViewTextBoxColumn9.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn10
			// 
			this.dataGridViewTextBoxColumn10.DataPropertyName = "MovId";
			...
			// 
			this.dataGridViewTextBoxColumn11.DataPropertyName = "FechaEmision";
			this.dataGridViewTextBoxColumn11.HeaderText = "FechaEmision";
			this.dataGridViewTextBoxColumn11.Name = "dataGridViewTextBoxColumn11";
			this.dataGridViewTextBoxColumn11.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn12
			// 
			this.dataGridViewTextBoxColumn12.DataPropertyName = "Vencimiento";
			...
			// 
			this.dataGridViewTextBoxColumn17.DataPropertyName = "Moneda";
			...
			// 
			this.dataGridViewTextBoxColumn16.DataPropertyName = "Saldo";
			...
			// 
			this.dataGridViewTextBoxColumn18.DataPropertyName = "TipoCambio";
			this.dataGridViewTextBoxColumn18.HeaderText = "TipoCambio";
			this.dataGridViewTextBoxColumn18.Name = "dataGridViewTextBoxColumn18";
			this.dataGridViewTextBoxColumn18.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn23
			// 
			this.dataGridViewTextBoxColumn23.DataPropertyName = "SaldoEnPesos";
			dataGridViewCellStyle3.Format = "C2";
			dataGridViewCellStyle3.NullValue = "0";
			this.dataGridViewTextBoxColumn23.DefaultCellStyle = dataGridViewCellStyle3;
			this.dataGridViewTextBoxColumn23.HeaderText = "SaldoEnPesos";
			this.dataGridViewTextBoxColumn23.Name = "dataGridViewTextBoxColumn23";
			this.dataGridViewTextBoxColumn23.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn24
			// 
			this.dataGridViewTextBoxColumn24.DataPropertyName = "SaldoSubTotal";
			dataGridViewCellStyle4.Format = "C2";
			dataGridViewCellStyle4.NullValue = "0";
			this.dataGridViewTextBoxColumn24.DefaultCellStyle = dataGridViewCellStyle4;
			this.dataGridViewTextBoxColumn24.HeaderText = "SaldoSubTotal";
			this.dataGridViewTextBoxColumn24.Name = "dataGridViewTextBoxColumn24";
			this.dataGridViewTextBoxColumn24.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn25
			// 
			this.dataGridViewTextBoxColumn25.DataPropertyName = "SaldoIva";
			dataGridViewCellStyle5.Format = "C2";
			dataGridViewCellStyle5.NullValue = "0";
			this.dataGridViewTextBoxColumn25.DefaultCellStyle = dataGridViewCellStyle5;
			this.dataGridViewTextBoxColumn25.HeaderText = "SaldoIva";
			this.dataGridViewTextBoxColumn25.Name = "dataGridViewTextBoxColumn25";
			this.dataGridViewTextBoxColumn25.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn26
			// 
			this.dataGridViewTextBoxColumn26.DataPropertyName = "SaldoRetIva";
			dataGridViewCellStyle6.Format = "C2";
			dataGridViewCellStyle6.NullValue = "0";
			this.dataGridViewTextBoxColumn26.DefaultCellStyle = dataGridViewCellStyle6;
			this.dataGridViewTextBoxColumn26.HeaderText = "SaldoRetIva";
			...
			this.dataGridViewTextBoxColumn27.DefaultCellStyle = dataGridViewCellStyle8;
			this.dataGridViewTextBoxColumn27.HeaderText = "SaldoTotal";
			this.dataGridViewTextBoxColumn27.Name = "dataGridViewTextBoxColumn27";
			this.dataGridViewTextBoxColumn27.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn28
			// 
			this.dataGridViewTextBoxColumn28.DataPropertyName = "SaldoDiferencia";
			dataGridViewCellStyle9.Format = "C2";
			dataGridViewCellStyle9.NullValue = "0";
			this.dataGridViewTextBoxColumn28.DefaultCellStyle = dataGridViewCellStyle9;
			this.dataGridViewTextBoxColumn28.HeaderText = "SaldoDiferencia";
			...
			// 
			this.dataGridViewTextBoxColumn14.DataPropertyName = "Impuestos";
			dataGridViewCellStyle11.Format = "C2";
			dataGridViewCellStyle11.NullValue = "0";
			this.dataGridViewTextBoxColumn14.DefaultCellStyle = dataGridViewCellStyle11;
			this.dataGridViewTextBoxColumn14.HeaderText = "Impuestos";
			this.dataGridViewTextBoxColumn14.Name = "dataGridViewTextBoxColumn14";
			this.dataGridViewTextBoxColumn14.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn15
			// 
			this.dataGridViewTextBoxColumn15.DataPropertyName = "Retencion";
			dataGridViewCellStyle12.Format = "C2";
			dataGridViewCellStyle12.NullValue = "0";
			this.dataGridViewTextBoxColumn15.DefaultCellStyle = dataGridViewCellStyle12;
			this.dataGridViewTextBoxColumn15.HeaderText = "Retencion";
			...
			this.Controls.Add(this.integracionSaldosDataGridView);
			this.Controls.Add(this.panel1);
			this.Icon = ((System.Drawing.Icon)(resources.GetObject("$this.Icon")));
			this.Name = "frmIntegracionSaldos";
		...
		private System.Windows.Forms.BindingSource integracionSaldosBindingSource;
		private System.Windows.Forms.DataGridView integracionSaldosDataGridView;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn SaldoRetISR;
