...
var AppComponent = /** @class */ (function () {
    function AppComponent(media, http, Router, userService) {
        ...
        this.items = [
            ...
            new main_1.Item("Solicitar", "Solicitar un Permiso", "description", '/solicitar'),
            new main_1.Item("Buscar", "Busca y descarga un permiso en formato PDF", "find_in_page", "/descargar")
        ];
