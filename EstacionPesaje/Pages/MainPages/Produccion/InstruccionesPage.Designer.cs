namespace EstacionPesaje.Pages.MainPages {
	partial class InstruccionesPage {
		...
		private void InitializeComponent () {
			...
			oTLabel.Location = new System.Drawing.Point(56, 9);
			...
			pRODUCTOLabel.Location = new System.Drawing.Point(10, 48);
			...
			cLIENTELabel.Location = new System.Drawing.Point(26, 29);
			...
			// 
			this.temporalOrdenTrabajoBindingSource.DataMember = "OrdenTrabajo";
			this.temporalOrdenTrabajoBindingSource.DataSource = this.tEMPCAPTBindingSource;
			// 
			// kryptonGroupBox2
			// 
			this.kryptonGroupBox2.Dock = System.Windows.Forms.DockStyle.Fill;
			this.kryptonGroupBox2.Location = new System.Drawing.Point(10, 109);
			this.kryptonGroupBox2.Name = "kryptonGroupBox2";
			// 
			// kryptonGroupBox2.Panel
			// 
			this.kryptonGroupBox2.Panel.Controls.Add(this.InstruccionesNavigator);
			this.kryptonGroupBox2.Size = new System.Drawing.Size(498, 428);
			...
			this.InstruccionesNavigator.Size = new System.Drawing.Size(494, 404);
			...
			this.kryptonTextBox2.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.temporalOrdenTrabajoBindingSource, "INSTIMPRESION", true));
			...
			this.kryptonTextBox2.Size = new System.Drawing.Size(492, 177);
			...
			this.kryptonPage3.Size = new System.Drawing.Size(557, 201);
			...
			this.kryptonTextBox1.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.temporalOrdenTrabajoBindingSource, "INSTLAMINACION", true));
			...
			this.kryptonTextBox1.Size = new System.Drawing.Size(557, 201);
			...
			this.kryptonPage4.Size = new System.Drawing.Size(557, 201);
			...
			this.kryptonTextBox3.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.temporalOrdenTrabajoBindingSource, "INSTREFINADO", true));
			...
			this.kryptonTextBox3.Size = new System.Drawing.Size(557, 201);
			this.kryptonTextBox3.TabIndex = 1;
			// 
			// kryptonPage5
			// 
			this.kryptonPage5.AutoHiddenSlideSize = new System.Drawing.Size(200, 200);
			this.kryptonPage5.Controls.Add(this.kryptonTextBox4);
			...
			this.kryptonPage5.Size = new System.Drawing.Size(557, 201);
			...
			this.kryptonTextBox4.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.temporalOrdenTrabajoBindingSource, "INSTDOBLADO", true));
			...
			this.kryptonTextBox4.Size = new System.Drawing.Size(557, 201);
			this.kryptonTextBox4.TabIndex = 1;
			// 
			// kryptonPage6
			// 
			this.kryptonPage6.AutoHiddenSlideSize = new System.Drawing.Size(200, 200);
			this.kryptonPage6.Controls.Add(this.kryptonTextBox5);
			...
			this.kryptonPage6.Size = new System.Drawing.Size(557, 201);
			...
			this.kryptonTextBox5.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.temporalOrdenTrabajoBindingSource, "INSTCORTE", true));
			...
			this.kryptonTextBox5.Size = new System.Drawing.Size(557, 201);
			this.kryptonTextBox5.TabIndex = 1;
			// 
			// kryptonPage7
			// 
			this.kryptonPage7.AutoHiddenSlideSize = new System.Drawing.Size(200, 200);
			this.kryptonPage7.Controls.Add(this.kryptonTextBox6);
			...
			this.kryptonPage7.Size = new System.Drawing.Size(557, 201);
			...
			this.kryptonTextBox6.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.temporalOrdenTrabajoBindingSource, "INSTEMBOBINADO", true));
			...
			this.kryptonTextBox6.Size = new System.Drawing.Size(557, 201);
			this.kryptonTextBox6.TabIndex = 1;
			// 
			// kryptonPage8
			// 
			this.kryptonPage8.AutoHiddenSlideSize = new System.Drawing.Size(200, 200);
			this.kryptonPage8.Controls.Add(this.kryptonTextBox7);
			...
			this.kryptonPage8.Size = new System.Drawing.Size(557, 201);
			...
			this.kryptonTextBox7.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.temporalOrdenTrabajoBindingSource, "INSTEXTRUSION", true));
			...
			this.kryptonTextBox7.Size = new System.Drawing.Size(557, 201);
			this.kryptonTextBox7.TabIndex = 1;
			// 
			// kryptonPage9
			// 
			this.kryptonPage9.AutoHiddenSlideSize = new System.Drawing.Size(200, 200);
			this.kryptonPage9.Controls.Add(this.kryptonTextBox8);
			...
			this.kryptonPage9.Size = new System.Drawing.Size(557, 201);
			...
			this.kryptonTextBox8.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.temporalOrdenTrabajoBindingSource, "INSTMANGAS", true));
			...
			this.kryptonTextBox8.Size = new System.Drawing.Size(557, 201);
			this.kryptonTextBox8.TabIndex = 1;
			// 
			// kryptonPage10
			// 
			this.kryptonPage10.AutoHiddenSlideSize = new System.Drawing.Size(200, 200);
			this.kryptonPage10.Controls.Add(this.kryptonTextBox9);
			...
			this.kryptonPage10.Size = new System.Drawing.Size(254, 50);
			...
			// kryptonTextBox9
			// 
			this.kryptonTextBox9.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
			this.kryptonTextBox9.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.temporalOrdenTrabajoBindingSource, "INSTSELLADO", true));
			this.kryptonTextBox9.Dock = System.Windows.Forms.DockStyle.Fill;
			this.kryptonTextBox9.Location = new System.Drawing.Point(0, 0);
			this.kryptonTextBox9.Multiline = true;
			this.kryptonTextBox9.Name = "kryptonTextBox9";
			this.kryptonTextBox9.ReadOnly = true;
			this.kryptonTextBox9.ScrollBars = System.Windows.Forms.ScrollBars.Both;
			this.kryptonTextBox9.Size = new System.Drawing.Size(254, 50);
			...
			this.kryptonPanel1.Location = new System.Drawing.Point(10, 5);
			this.kryptonPanel1.Name = "kryptonPanel1";
			this.kryptonPanel1.Size = new System.Drawing.Size(498, 104);
			...
			this.cLIENTEKryptonWrapLabel.LabelStyle = ComponentFactory.Krypton.Toolkit.LabelStyle.NormalPanel;
			this.cLIENTEKryptonWrapLabel.Location = new System.Drawing.Point(87, 29);
			...
			this.pRODUCTOKryptonWrapLabel.LabelStyle = ComponentFactory.Krypton.Toolkit.LabelStyle.NormalPanel;
			this.pRODUCTOKryptonWrapLabel.Location = new System.Drawing.Point(87, 48);
			...
			this.oTKryptonWrapLabel.LabelStyle = ComponentFactory.Krypton.Toolkit.LabelStyle.NormalPanel;
			this.oTKryptonWrapLabel.Location = new System.Drawing.Point(87, 9);
			...
			this.kryptonCheckBox1.LabelStyle = ComponentFactory.Krypton.Toolkit.LabelStyle.BoldPanel;
			this.kryptonCheckBox1.Location = new System.Drawing.Point(87, 74);
			this.kryptonCheckBox1.Name = "kryptonCheckBox1";
			this.kryptonCheckBox1.Size = new System.Drawing.Size(86, 20);
			this.kryptonCheckBox1.TabIndex = 8;
			this.kryptonCheckBox1.Values.Text = "Disponible";
			// 
			...
			this.Load += new System.EventHandler(this.InstruccionesPage_Load);
