...
namespace ControlNominasAddIn.Forms
{
    public partial class frmConfiguration : KryptonForm
    {
        ...
        public frmConfiguration()
        {
            ...
            PermisosStringBulder = new OleDbConnectionStringBuilder(appSetting.GetConnectionString(AppSetting.PERMISOS_KEY));
            Reloj1StringBulder = new OleDbConnectionStringBuilder(appSetting.GetConnectionString(AppSetting.RELOJ1_KEY));
            Reloj2StringBulder = new OleDbConnectionStringBuilder(appSetting.GetConnectionString(AppSetting.RELOJ2_KEY));
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            appSetting.SaveConnectionString(AppSetting.PERMISOS_KEY, PermisosStringBulder.ConnectionString);
            appSetting.SaveConnectionString(AppSetting.RELOJ1_KEY, Reloj1StringBulder.ConnectionString);
            appSetting.SaveConnectionString(AppSetting.RELOJ2_KEY, Reloj2StringBulder.ConnectionString);
