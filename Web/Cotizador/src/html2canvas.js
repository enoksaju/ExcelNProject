      ...
      4: [
        function(_dereq_, module, exports) {
          ...
          function renderWindow(node, container, options, windowWidth, windowHeight) {
            ...
            var width =
              options.type === 'view' ? windowWidth : documentWidth(clonedWindow.document);
            var height =
              options.type === 'view' ? windowHeight : documentHeight(clonedWindow.document);
      ...
      14: [
        function(_dereq_, module, exports) {
          ...
          NodeContainer.prototype.css = function(attribute) {
            ...
            return (
              this.styles[attribute] || (this.styles[attribute] = this.computedStyles[attribute])
            );
          };
          ...
          NodeContainer.prototype.color = function(attribute) {
            return (
              this.colors[attribute] || (this.colors[attribute] = new Color(this.css(attribute)))
            );
          };
          ...
          NodeContainer.prototype.parseBackgroundPosition = function(
            ...
            if (isPercentage(position[0])) {
              left =
                (bounds.width - (backgroundSize || image).width) * (parseFloat(position[0]) / 100);
            } else {
            ...
            if (position[1] === 'auto') {
              ...
              top =
                ((bounds.height - (backgroundSize || image).height) * parseFloat(position[1])) /
                100;
            } else {
      ...
      15: [
        function(_dereq_, module, exports) {
          ...
          function inlineLevel(container) {
            return (
              ['inline', 'inline-block', 'inline-table'].indexOf(container.css('display')) !== -1
            );
          }
