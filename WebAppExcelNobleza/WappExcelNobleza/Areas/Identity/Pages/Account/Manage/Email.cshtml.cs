...
namespace ExcelNoblezaBlazor.Areas.Identity.Pages.Account.Manage
{
	public partial class EmailModel : PageModel
	{
		...
		{
			[Required(ErrorMessage ="El correo nuevo es requerido")]
			[EmailAddress]
		...
		public async Task<IActionResult> OnPostChangeEmailAsync()
		{
			...
			if (Input.NewEmail != email)
			{
				...
				await _emailSender.SendEmailAsync(
					Input.NewEmail,
					"Confirme su email",
					$"Por favor, confirme su email haciendo <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>click aquí</a>.");

				StatusMessage = "Se ha enviado el link para cambiar su email, por favor revise su bandeja de entrada.";
